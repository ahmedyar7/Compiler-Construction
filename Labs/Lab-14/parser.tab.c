...
static const char *const yytname[] =
{
  ...
  "statement", "declaration", "assignment", "expr", YY_NULLPTR
};
...
{
      -3,    -8,     0,     4,    -3,   -14,   -14,   -14,     2,     1,
     -14,   -14,     3,     6,     7,    -1,   -14,     5,     8,     9,
      12,     7,    10,    11,    13,    14,   -14,   -14
};
...
{
       1,     8,     2,     9,    10,    12,    18,    13,    23,    14,
      15,    16,    19,     0,    20,    21,    22,    24,    25,    11,
       0,    26,    27
};

static const yytype_int8 yycheck[] =
{
       3,     9,     5,     3,     0,     3,     7,     6,    21,     6,
       4,     4,     7,    -1,     6,     6,     4,     7,     7,     4,
      -1,     8,     8
};
...
{
       0,     3,     5,    11,    12,    13,    14,    15,     9,     3,
       0,    13,     3,     6,     6,     4,     4,    16,     7,     7,
       6,     6,     4,    16,     7,     7,     8,     8
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 7: /* declaration: INT ID '[' NUM ']' '[' NUM ']' ';'  */
#line 45 "parser.y"
                                                { 
    add_to_symbol_table((yyvsp[-7].id), (yyvsp[-5].num), (yyvsp[-2].num), 4); 
}
#line 1088 "parser.tab.c"
    break;

  case 8: /* assignment: ID '=' ID '[' expr ']' '[' expr ']' ';'  */
#line 50 "parser.y"
                                                    {
    /* Note: For a fully complete 3AC, you would look up the columns of $3 
       from the symbol table here instead of hardcoding '4'. 
    */
    printf("t1 = %d * 4\n", (yyvsp[-5].num));       // Multiply row index by total columns
    printf("t2 = t1 + %d\n", (yyvsp[-2].num));      // Add column index
    printf("t3 = t2 * 4\n");           // Multiply by data width (int = 4 bytes)
    printf("%s = %s[t3]\n", (yyvsp[-9].id), (yyvsp[-7].id));   // Final assignment
}
